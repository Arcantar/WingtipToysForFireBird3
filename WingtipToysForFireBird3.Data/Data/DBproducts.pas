...
type
  ...
  public
    ...
    class method insert_or_update_products( PRODUCTID: System.Int64   ; PRODUCTNAME: System.String  ; DESCRIPTION: System.String  ; IMAGEPATH: System.String  ; UNITPRICE: System.Double  ; CATEGORYID: System.Int64   ):System.Int32;
    class method insert_products( PRODUCTNAME: System.String  ; DESCRIPTION: System.String  ; IMAGEPATH: System.String  ; UNITPRICE: System.Double  ; CATEGORYID: System.Int64   ):System.Int32;
...
begin
   ...
   sqlCommand.Append('select  PRODUCTID, PRODUCTNAME, DESCRIPTION, IMAGEPATH, UNITPRICE, CATEGORYID from products where PRODUCTID= @PRODUCTID;');
...
begin
   var sqlCommand: StringBuilder := new StringBuilder;
   sqlCommand.Append('select  PRODUCTID, PRODUCTNAME, DESCRIPTION, IMAGEPATH, UNITPRICE, CATEGORYID from products where CATEGORYID= @CATEGORYID;');
   var arParams: array of FbParameter := new FbParameter[1];
...
begin
   var sqlCommand: StringBuilder := new StringBuilder;
   sqlCommand.Append('select  PRODUCTID, PRODUCTNAME, DESCRIPTION, IMAGEPATH, UNITPRICE, CATEGORYID from products where '+value);
...
class method DBproducts.insert_or_update_products( PRODUCTID: System.Int64   ; PRODUCTNAME: System.String  ; DESCRIPTION: System.String  ; IMAGEPATH: System.String  ; UNITPRICE: System.Double  ; CATEGORYID: System.Int64   ):System.Int32;
Begin
   var sqlCommand: StringBuilder := new StringBuilder;
   sqlCommand.Append('UPDATE or INSERT INTO products ( PRODUCTID, PRODUCTNAME, DESCRIPTION, IMAGEPATH, UNITPRICE, CATEGORYID)');
   sqlCommand.Append('  VALUES ( @PRODUCTID, @PRODUCTNAME, @DESCRIPTION, @IMAGEPATH, @UNITPRICE, @CATEGORYID)');
...
class method DBproducts.insert_products(  PRODUCTNAME: System.String  ; DESCRIPTION: System.String  ; IMAGEPATH: System.String  ; UNITPRICE: System.Double  ; CATEGORYID: System.Int64   ):System.Int32;
Begin
   var sqlCommand: StringBuilder := new StringBuilder;
   sqlCommand.Append('INSERT INTO products ( PRODUCTNAME, DESCRIPTION, IMAGEPATH, UNITPRICE, CATEGORYID)');
   sqlCommand.Append('  VALUES (  @PRODUCTNAME, @DESCRIPTION, @IMAGEPATH, @UNITPRICE, @CATEGORYID)');
