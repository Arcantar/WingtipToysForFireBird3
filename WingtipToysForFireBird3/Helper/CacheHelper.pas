namespace WingtipToysForFireBird3.Helper;
...
type
  ...
  public
    ...
    class method GetProductList(categoryId:nullable Int64; categoryName:nullable String): list<WingtipToysForFireBird3.Data.Business.products>;
    class method GetProducts(productId: nullable Int64; productName: String): list<WingtipToysForFireBird3.Data.Business.products>;
    class method GetCategories:List<WingtipToysForFireBird3.Data.Business.categories>;
  end;
...
class method CacheHelper.GetProductList(categoryId: nullable Int64; categoryName: nullable String): list<WingtipToysForFireBird3.Data.Business.products>;
begin
 ...
 var expiration: DateTime := DateTime.Now.AddHours(1);
 exit CacheManager.Cache.Get<list<WingtipToysForFireBird3.Data.Business.products>>(cachekey, expiration, () -> begin
      var _db := new WingtipToysForFireBird3.Models.ProductContext();
      var query: list<WingtipToysForFireBird3.Data.Business.products> ;
...
class method CacheHelper.GetProducts(productId: nullable Int64; productName: String): list<WingtipToysForFireBird3.Data.Business.products>;
begin
...
class method CacheHelper.GetCategories:List<WingtipToysForFireBird3.Data.Business.categories>;
begin
 var cachekey: System.String := 'CategoriesList';
 var expiration: DateTime := DateTime.Now.AddHours(1);
 exit CacheManager.Cache.Get<List<WingtipToysForFireBird3.Data.Business.categories>>(cachekey, expiration, () -> begin
