...
begin
  if not IsPostBack then begin
    ...
    if ret then begin
      ...
      var myCurrentOrder: WingtipToysForFireBird3.Data.Business.orders;
      if currentOrderId >= 0 then begin
        //  Get the order based on order id.
        myCurrentOrder := WingtipToysForFireBird3.Data.Business.orders.select_orders_Orderid_to_list(currentOrderId);
