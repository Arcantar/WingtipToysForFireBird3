namespace WingtipToysForFireBird3.Checkout;
...
begin
  if not IsPostBack then begin
    ...
    if ret then begin
      ...
      var myOrder := new WingtipToysForFireBird3.Data.Business.orders;
      ...
      using usersShoppingCart: ShoppingCartActions := new ShoppingCartActions() do begin
        var myOrderList: List<WingtipToysForFireBird3.Data.Business.cartitem> := usersShoppingCart.GetCartItems();
        //  Add OrderDetail information to the DB for each product purchased.
        for each orderdet in myOrderList do begin
          //  Create a new OrderDetail object.
          var myOrderDetail := new WingtipToysForFireBird3.Data.Business.orderdetails;
        ...
        var orderList: List<WingtipToysForFireBird3.Data.Business.orders> := new List<WingtipToysForFireBird3.Data.Business.orders>();
