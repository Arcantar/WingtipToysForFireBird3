...
begin
  ...
  begin
    var myOrderList: List<WingtipToysForFireBird3.Data.Business.cartitem> := myCartOrders.GetCartItems();
...
begin
  ...
  try
    ...
    begin
      //  Log the exception.
      WingtipToysForFireBird3.Logic.ExceptionUtility.LogException(e, 'HttpCall in PayPalFunction.pas');
    end;
  end;
