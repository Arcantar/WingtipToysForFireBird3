...
type
  ...
  public
   ...
   method GetCartItems: List<WingtipToysForFireBird3.Data.Business.cartitem>;
...
method ShoppingCartActions.GetCartItems: List<WingtipToysForFireBird3.Data.Business.cartitem>;
begin
  ShoppingCartId := GetCartId();
  exit WingtipToysForFireBird3.Data.Business.cartitem.select_cartitems_Itemid_to_list(new Guid(ShoppingCartId))  ;
end;
...
begin
  using db := new WingtipToysForFireBird3.Models.ProductContext() do
  begin
    try
      var CartItemCount: Integer := CartItemUpdates.Count-1;
      var myCart: List<WingtipToysForFireBird3.Data.Business.cartitem> := GetCartItems();
