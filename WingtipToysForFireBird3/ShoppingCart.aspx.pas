...
type
  ...
  public
    method GetShoppingCartItems: List<WingtipToysForFireBird3.Data.Business.cartitem>;
    method UpdateCartItems: List<WingtipToysForFireBird3.Data.Business.cartitem>;
...
method ShoppingCart.GetShoppingCartItems: List<WingtipToysForFireBird3.Data.Business.cartitem>;
begin
  var actions: ShoppingCartActions := new ShoppingCartActions();
  exit actions.GetCartItems();
end;

method ShoppingCart.UpdateCartItems: List<WingtipToysForFireBird3.Data.Business.cartitem>;
begin
  using usersShoppingCart: ShoppingCartActions := new ShoppingCartActions() do
  begin
